...
const restaurantNavItems = [
  ...
  { 
    ...
    submenu: [
      ...
      { to: '/profile/domain', icon: Globe, label: 'Domínio Próprio' }
    ]
  },
        ...
        <nav className="p-3 md:p-4 space-y-1 md:space-y-2 flex-1">
          {navItems.map((item) => (
            <div key={item.to}>
                  ...
                  <button
                    ...
                    className={`flex items-center ${
                      isCollapsed && window.innerWidth >= 768 
                        ...
                        : 'space-x-3 px-3'
                    } py-2.5 md:py-2 rounded-lg text-sm font-medium transition-colors relative group w-full ${
              ...
              {/* Submenu */}
              {item.submenu && expandedMenus[item.label] && (!isCollapsed || window.innerWidth < 768) && (
